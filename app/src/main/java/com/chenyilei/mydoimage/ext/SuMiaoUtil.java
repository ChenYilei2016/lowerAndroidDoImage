package com.chenyilei.mydoimage.ext;
 ...
 * @date 2019/05/12- 16:43
 */
public class SuMiaoUtil {
    ...
    private static int[] deceasecolorCompound(int[] guassBlur, int[] gray, int width, int height)
    {
        int a, b, temp;
        float ex;
    ...
    private static Bitmap create(int[] pixels , int[] output,int width , int height)
    {
